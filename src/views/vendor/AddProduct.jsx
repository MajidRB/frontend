...
function AddProduct() {
    ...
    const handleProductCreate = async (e) => {
        ...
        const response = await apiInstance.post(`vendor/product-create/`, formdata, {
            headers: {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Poduct Added Successfully',
            timer: 2000,
                        ...
                        <div className='flex-fill' >
                            ...
                            <form onSubmit={handleProductCreate}>
                                ...
                                <div className='d-flex justify-content-center'>
                                    <button type='submit' className='btn btn-success' style={{ width: '400px', maxWidth: '400px' }} >Add New Product</button>
                                </div>
                            </form>
